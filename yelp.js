...
//                     if (document.querySelector('#dWIcon1').childElementCount >= 5 && document.querySelector('#dWTemp1').childElementCount >= 5) {
...
//                         iconElement = document.createElement('div')
//                         // iconElement.setAttribute("class", "col-md-5")
//                         // iconElement.style.display = "inline-block"
//                         tempElement = document.createElement('div')
//                         tempElement.style.padding = "10px 30px 10px 30px"
//                         mIconElement = document.createElement('div')
//                         mTempElement = document.createElement('div')
//                         iconElement.innerHTML = `<img src="http://openweathermap.org/img/w/${weatherIcon[j]}.png" alt="${weatherIcon[j]}">`
//                         tempElement.innerHTML = ~~`${storeWeather[j]}` + "&#176"
//                         mIconElement.innerHTML = `<img src="http://openweathermap.org/img/w/${weatherIcon[j]}.png" alt="${weatherIcon[j]}">`
//                         mTempElement.innerHTML = ~~`${storeWeather[j]}` + "&#176"
//                         document.querySelector('#dWIcon1').append(iconElement)
//                         document.querySelector('#dWTemp1').append(tempElement)
    ...
    fetch(queryURL, {
        ...
        .then(({ businesses }) => {
            ...
            for (let i = 0; i < 3; i++) {
                ...
                if (document.querySelector('#mYelp0').childElementCount >= 3) {
                    if (document.querySelector('#mYelp1').childElementCount >= 3) {
                        if (document.querySelector('#mYelp2').childElementCount >= 3) {
                            null
                        } else {

                            document.querySelector(`#mYelp2`).innerHTML = `
                        ...
                        document.querySelector(`#mYelp1`).innerHTML = `
                                <div class="card scrollContent" style="width: 18rem;">
                                    <div class="card-body">
                                        <h5 class="card-title">${name[0]}%</h5>
                                        <h6 class="card-subtitle mb-2 text-muted">${rating[0]}</h6>
